...
import org.wallride.core.repository.TagFullTextSearchTerm;
...
public class TagService {
	...
	public Page<Tag> readTags(TagSearchRequest request, Pageable pageable) {
		TagFullTextSearchTerm term = request.toFullTextSearchTerm();
		return tagRepository.findByFullTextSearchTerm(term, pageable);
	}
}
