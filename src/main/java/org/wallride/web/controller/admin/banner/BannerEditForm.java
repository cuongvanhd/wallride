...
import org.wallride.core.service.BannerUpdateRequest;
...
public class BannerEditForm extends DomainObjectEditForm {
	...
	public BannerUpdateRequest buildBannerUpdateRequest() {
		BannerUpdateRequest.Builder builder = new BannerUpdateRequest.Builder();
		return builder
				.language(language)
				.type(type)
				.imageId(imageId)
