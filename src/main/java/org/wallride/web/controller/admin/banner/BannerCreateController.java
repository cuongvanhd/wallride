...
public class BannerCreateController {
	...
	public BannerCreateForm bannerCreateForm() {
		BannerCreateForm form = new BannerCreateForm();
		form.setType(Banner.Type.MAIN);
		return form;
	}
...
//	}
	...
	public String publish(
		...
		Banner banner = null;
		try {
			banner = bannerService.createBanner(form.buildBannerCreateRequest(), errors, authorizedUser);
		}
