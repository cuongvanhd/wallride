...
<article id="k2Container" class="itemView<?php echo $k2ContainerClasses; ?>"> <?php echo $this->item->event->BeforeDisplay; ?> <?php echo $this->item->event->K2BeforeDisplay; ?>
		...
		<header>
			...
			<?php if($params->get('itemTitle')): ?>
				...
				<ul>
						...
						<li>
								<time datetime="<?php echo JHTML::_('date', $this->item->created, JText::_(DATE_W3C)); ?>"> <?php echo JHTML::_('date', $this->item->created, JText::_('d F, Y')); ?></span> </time>
						</li>
						<?php endif; ?>
		...
		<div class="itemBody"> <?php echo $this->item->event->BeforeDisplayContent; ?> <?php echo $this->item->event->K2BeforeDisplayContent; ?>
				...
				<div class="itemBottom">
						...
						<small class="itemDateModified"> <?php echo JText::_('K2_LAST_MODIFIED_ON') ?> <time datetime="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>"><?php JHTML::_('date', $this->item->modified, JText::_('K2_DATE_FORMAT_LC2')); ?></time> </small>
						<?php endif; ?>
						...
						<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
								...
								<div>
										...
										<div><span> <?php echo JText::_('K2_POSTED_BY'); ?>
												...
												<?php endif; ?>
												</span> <span><time datetime="<?php echo JHtml::_('date', $comment->commentDate, JText::_(DATE_W3C)); ?>"> <?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_LC2')); ?></time> </span> <span> <a class="commentLink" href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>"> <?php echo JText::_('K2_COMMENT_LINK'); ?> </a> </span></div>
								</div>
						</li>
						<?php endforeach; ?>
				</ul>
