...
function getUpdates() {    
     ...
     var update_url = 'https://www.gavick.com/updates/json/tmpl,component/query,product/product,gk_fashion_j16';
                ...
                if(templateVersion.length > 2) {
                    ...
                    if(updateVersion[0] >= templateVersion[0] && updateVersion[1] >= templateVersion[1] && updateVersion[2] > templateVersion[2]) {
                        ...
                        isNewer = true;
                         ...
                         if(updateVersion[1] >= templateVersion[1] && updateVersion[0] >= templateVersion[0]) {

                            console.log(templateVersion[1]+' '+updateVersion[1]);
