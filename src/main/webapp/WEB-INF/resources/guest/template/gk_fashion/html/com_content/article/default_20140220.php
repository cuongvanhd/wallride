...
<div class="googleads" style="width:100%; text-align:center; padding-top:15px;">
...
<?php endif; ?>
	...
	<?php if (!empty($this->item->pagination) AND $this->item->pagination AND $this->item->paginationposition AND $this->item->paginationrelative): ?>
		<?php echo $this->item->pagination;?>
	<?php endif; ?>
<div class="googleads" style="width:100%; text-align:center; margin-top:10px; padding-top:10px; border-top:1px solid #EEEEEE;">
